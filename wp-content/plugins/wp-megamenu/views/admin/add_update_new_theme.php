                            ...
                            <td>
                                <table>
                                    <tr>
                                        ...
                                        <?php
                                        $menubar_bg_gradient_angle = !empty(get_wpmm_theme_option('menubar_bg_gradient_angle', $theme_id)) ? intval(get_wpmm_theme_option('menubar_bg_gradient_angle', $theme_id)) : -90;
                                ...
                                <div>
                                    <label class="text_and_input">
                                        ...
                                        <select name="wpmm_theme_option[top_level_item_text_transform]">
                                            <option value="none" <?php selected(get_wpmm_theme_option('top_level_item_text_transform', $theme_id), 'none') ?> > <?php _e('None', 'wp-megamenu'); ?> </option>
                                            <option value="inherit" <?php selected(get_wpmm_theme_option('top_level_item_text_transform', $theme_id), 'inherit') ?> > <?php _e('Inherit', 'wp-megamenu'); ?> </option>
                            ...
                            <td>
                                <table>
                                    <tr>
                                        ...
                                        <?php
                                        $top_level_item_bg_color_gradient_angle = !empty(get_wpmm_theme_option('top_level_item_bg_color_gradient_angle', $theme_id)) ? intval(get_wpmm_theme_option('top_level_item_bg_color_gradient_angle', $theme_id)) : -90;
                                ...
                                <div>
                                    <label class="text_and_input">
                                        ...
                                        <select name="wpmm_theme_option[dropdown_submenu_item_text_transform]">
                                            <option value="none" <?php selected(get_wpmm_theme_option('dropdown_submenu_item_text_transform', $theme_id), 'none') ?> > <?php _e('None', 'wp-megamenu'); ?> </option>
                                            <option value="inherit" <?php selected(get_wpmm_theme_option('dropdown_submenu_item_text_transform', $theme_id), 'inherit') ?> > <?php _e('Inherit', 'wp-megamenu'); ?> </option>
                                ...
                                <div>
                                    <label class="text_and_input">
                                        ...
                                        <select name="wpmm_theme_option[widgets_heading_text_transform]">
                                            ...
                                            <option value="none" <?php selected(get_wpmm_theme_option('widgets_heading_text_transform',
                                                $theme_id), 'none') ?> > <?php _e('None', 'wp-megamenu'); ?> </option>
                                            
                                            <option value="inherit" <?php selected(get_wpmm_theme_option('widgets_heading_text_transform',
                                                $theme_id), 'inherit') ?> > <?php _e('Inherit', 'wp-megamenu'); ?> </option>
